...
<div id="Work_Experience">
  ...
  <ul>
    ...
    <li>
      <h3><img src="https://assets.tryhackme.com/img/paths/SOCL1.svg" alt="Tryhackme SOC Analyst icon" style="width:20%;height:20%;">I am following the SOC Analyst 1 path in the tryhackme platform.</h3>
    </li>
  </ul>
</div>
